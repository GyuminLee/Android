...
public class ShortenExample extends ParentExample {

	private static final String TAG = "ShortenExample";
	public ShortenExample(Handler handler, OnCompleteListener listener) {
	...
	void executeExample() throws IOException {
        ...
        Log.e(TAG,"Writing IsoFile speed : " + (new File(String.format("output-%f-%f--%f-%f.mp4", startTime1, endTime1, startTime2, endTime2)).length() / (start3 - start2) / 1000) + "MB/s");
	}
