...
public class Session {
    ...
    private Session(final Context context){
        ...
        this.appKey = GlobalApplication.getGlobalApplicationContext().getAppKey();
        if(appKey == null)
            throw new KakaoException(ERROR_TYPE.MISS_CONFIGURATION, String.format("need to declare %s in your AndroidManifest.xml", GlobalApplication.APP_KEY_PROPERTY));
