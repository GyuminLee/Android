 ...
 */
package com.example.sampleandar.parser;

import java.io.BufferedReader;
import java.io.IOException;

import com.example.sampleandar.models.Material;
			...
			line = is.readLine(), lineNum++)
			{
				...
				if (line.length() > 0) {
					if (line.startsWith("newmtl ")) {
						...
						//f? resources:Bitmap mBitmap = BitmapFactory.decodeResource(getResources(),R.drawable.pic1);
